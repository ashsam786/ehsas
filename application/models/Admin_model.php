        ...
        foreach ($rResult->result_array() as $aRow) {
            ...
            foreach ($aColumns as $col) {
                ...
                if($col == 'edit'){
                    ...
                    $edit .= ' | <a class="getConfirmation" href="'.base_url('admin/donor/delete/'.$aRow['id']).'"  data-toggle="confirmation" data-placement="top"><i class="fa fa-trash" aria-hidden="true"></i></a>';
                    $row[] = $edit;
                } else{
                    $row[] = $aRow[$col];
                }
